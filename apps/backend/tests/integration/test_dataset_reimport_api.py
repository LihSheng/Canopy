...
def _create_dataset_via_api(
    client, auth_headers, monkeypatch, tmp_path, xlsx_buffer, project_name, connection_name, dataset_name
):
    ...
    project_resp = client.post(
        "/api/projects/", json={"name": project_name, "description": "Test project"}, headers=auth_headers
    )
    ...
    connection_resp = client.post(
        ...
        json={
            ...
            "config_json": {"file_name": preview["file_name"], "source_file_path": preview["source_file_path"]},
        },
        headers=auth_headers,
    )
